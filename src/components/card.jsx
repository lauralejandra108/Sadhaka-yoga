...
export const Card = ({ name, number, frontFace, flipCard, unflippedCards, disabledCards }) => {
  ...
  return (
    ...
    <ReactCardFlip isFlipped={isFlipped} >
      <img className='card-image' src='./src/assets/front.png' alt='back-face' onClick={hasEvent ? handleClick : null} />
